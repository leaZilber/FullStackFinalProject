        ...
        <>
            ...
            <div className="aboutUsContainer">
                ...
                <div className="sidebarInfo">
                    <h4>About Us</h4>
                    <h3>SafeSkin - זיהוי מוקדם, הגנה חכמה</h3>
                    <p>
                        At SkinGuard AI, we are dedicated to revolutionizing early skin cancer detection through cutting-edge AI technology. Our mission is to provide a smart, accessible, and reliable tool that empowers users to monitor their skin health with confidence.
                    </p>
                    <h5>Who We Are</h5>
                    ...
                    <h5>What We Do</h5>
                    <p>SkinGuard AI is a smart skin monitoring application that enables users to:</p>
                    <ul>
                        <li>✅ Scan and analyze moles and skin spots using AI-powered image recognition.</li>
                        <li>✅ Track changes over time through automatic image comparison and risk analysis.</li>
                        <li>✅ Receive timely reminders for re-evaluation and check-ups.</li>
                        <li>✅ Connect with dermatologists for expert consultation.</li>
                        <li>✅ Access a comprehensive educational hub on skin health and warning signs.</li>
                    </ul>
                    <h5>How It Works</h5>
                    <p>
                        Our app utilizes deep learning models trained to detect patterns in skin lesions and anomalies. Using AI-driven computer vision technology, it can assess risk factors and alert users if a skin spot requires professional evaluation. We integrate real-time updates and secure data storage, ensuring that users can track their skin’s condition over time with ease.
                    ...
                    <p>Join us in making early skin cancer detection accessible to everyone!</p>
                </div>
            </div>
        </>
    );
